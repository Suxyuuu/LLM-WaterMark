...
def get_wikitext2(nsamples, seed, seqlen, tokenizer):
    ...
    # traindata = load_dataset('wikitext', 'wikitext-2-raw-v1', split='train', cache_dir='./dataset')
    # testdata = load_dataset('wikitext', 'wikitext-2-raw-v1', split='test', cache_dir='./dataset')
